	...
	<div class="container">
		<div class="panel panel-custom">
			<div class="panel-heading">
				<span class="session-title">Detalhes da Saída</span>
				<div class="pull-right">
					<a class="btn btn-warning" href="/saidas/${mov.id}/update" role="button" >Editar</a>					
					<a class="btn btn-danger" href="#" data-href="/saidas/${mov.id}/delete" data-toggle="modal" data-target="#confirm-delete">Deletar</a>
				</div>
			</div>
